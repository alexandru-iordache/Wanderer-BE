...
{
    /// <inheritdoc />
    public partial class AddQuartzRelatedTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = @"CREATE TABLE [dbo].[QRTZ_CALENDARS] (
        ...
        {
            var sql = @"IF OBJECT_ID(N'[dbo].[FK_QRTZ_TRIGGERS_QRTZ_JOB_DETAILS]', N'F') IS NOT NULL
